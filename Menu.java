...
public final class Menu {
    ...
    public static final Plat[] PLATS = {
        new Plat("Salade de lentilles", Categorie.ENTREE, 140, true),
        ...
        new Plat("Curry de pois chiches", Categorie.PLAT, 280, true),
        new Plat("Yaourt nature", Categorie.DESSERT, 95, true),
